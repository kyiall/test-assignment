...
async def list_organizations_by_parent_activity(
        parent_activity: int, db: AsyncSession = Depends(get_db)
):
    """Поиск организаций по виду деятельности, которая находится на первом уровне дерева"""
